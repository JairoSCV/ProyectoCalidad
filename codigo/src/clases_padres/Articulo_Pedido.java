...
public class Articulo_Pedido {
	protected String nroBoleta,Solicitud,medida,material;
	protected double peso,montoAmortiguado;
        protected int cantidad;
        protected String fabricacion,entrega,pago;
        protected String entrega_material;

    public Articulo_Pedido(String nroBoleta, String Solicitud, String medida, String material, double peso, double montoAmortiguado, int cantidad, String fabricacion, String entrega, String pago, String entrega_material) {
